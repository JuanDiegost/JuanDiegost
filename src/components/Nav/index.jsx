		...
		<nav className='shadow-2'>
			<div className="flex justify-around py-4">
				...
				<div className="flex gap-x-4">
					<a className="hover:cursor-pointer" href='https://www.linkedin.com/in/juandiegost/' target='_blank'  >{linkedinLogo}</a>
					<a className="hover:cursor-pointer" href='https://github.com/JuanDiegost' target='_blank'  >{githubLogo}</a>
